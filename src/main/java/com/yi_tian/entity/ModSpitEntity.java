...
public class ModSpitEntity extends LlamaSpitEntity {
    private String name;
    public ModSpitEntity(EntityType<? extends LlamaSpitEntity> entityType, World world) {
        super(entityType, world);
        this.name="spit";
    }
    public ModSpitEntity(World world, LlamaEntity owner) {
